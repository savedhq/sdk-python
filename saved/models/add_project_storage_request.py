...
class AddProjectStorageRequest(BaseModel):
    """
    AddProjectStorageRequest
    """ # noqa: E501
    client_storage_id: StrictStr
    __properties: ClassVar[List[str]] = ["client_storage_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "client_storage_id": obj.get("client_storage_id")
        })
        return _obj

...
class ListWorkspaces200Response(BaseModel):
    ...
    items: Optional[List[ListWorkspaces200ResponseAllOfItemsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "total": obj.get("total"),
            "items": [ListWorkspaces200ResponseAllOfItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj

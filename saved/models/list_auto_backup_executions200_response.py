...
class ListAutoBackupExecutions200Response(BaseModel):
    """
    ListAutoBackupExecutions200Response
    """ # noqa: E501
    executions: Optional[List[ListAutoBackupExecutions200ResponseExecutionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "executions": [ListAutoBackupExecutions200ResponseExecutionsInner.from_dict(_item) for _item in obj["executions"]] if obj.get("executions") is not None else None
        })
        return _obj

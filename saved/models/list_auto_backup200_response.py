...
class ListAutoBackup200Response(BaseModel):
    """
    ...
    items: Optional[List[ListAutoBackup200ResponseAllOfItemsInner]] = None
    __properties: ClassVar[List[str]] = ["page", "limit", "total", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "total": obj.get("total"),
            "items": [ListAutoBackup200ResponseAllOfItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj

...
class GetSubscription200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["subscription_id", "status", "current_period_start", "current_period_end"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'past_due', 'canceled', 'incomplete']):
            raise ValueError("must be one of enum values ('active', 'past_due', 'canceled', 'incomplete')")
        return value

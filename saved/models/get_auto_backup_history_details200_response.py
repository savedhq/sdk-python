...
class GetAutoBackupHistoryDetails200Response(BaseModel):
    """
    GetAutoBackupHistoryDetails200Response
    """ # noqa: E501
    events: Optional[List[GetAutoBackupHistoryDetails200ResponseEventsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [GetAutoBackupHistoryDetails200ResponseEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
        return _obj

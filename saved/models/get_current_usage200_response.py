...
class GetCurrentUsage200Response(BaseModel):
    """
    GetCurrentUsage200Response
    """ # noqa: E501
    storage_gb: Optional[Union[StrictFloat, StrictInt]] = None
    computation_seconds: Optional[Union[StrictFloat, StrictInt]] = None
    transfer_gb: Optional[Union[StrictFloat, StrictInt]] = None
    period_start: Optional[datetime] = None
    period_end: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["storage_gb", "computation_seconds", "transfer_gb", "period_start", "period_end"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transfer_gb": obj.get("transfer_gb"),

...
class ConfirmBackupUploadedRequest(BaseModel):
    """
    ConfirmBackupUploadedRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Actual filename")
    size: StrictInt = Field(description="File size in bytes")
    checksum: StrictStr = Field(description="SHA256 hash of the file")
    content_type: StrictStr = Field(description="MIME type of the file")
    __properties: ClassVar[List[str]] = ["name", "size", "checksum", "content_type"]

...
class ListPaymentMethods200ResponseInner(BaseModel):
    """
    ListPaymentMethods200ResponseInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    card: Optional[ListPaymentMethods200ResponseInnerCard] = None
    __properties: ClassVar[List[str]] = ["id", "type", "card"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "card": ListPaymentMethods200ResponseInnerCard.from_dict(obj["card"]) if obj.get("card") is not None else None
        })
        return _obj

...
class StoragesApi:
    ...
    def _create_storage_serialize(
        ...
        if create_storage_request is not None:
            _body_params = create_storage_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/workspaces/{workspace_id}/storages',
    ...
    def _delete_storage_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/workspaces/{workspace_id}/storages/{storage_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_storage(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListStorages200ResponseAllOfItemsInner",
            '400': "ListWorkspaces401Response",
            '401': "ListWorkspaces401Response",
    ...
    def _update_storage_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_storage_request is not None:
            _body_params = update_storage_request
